 ...
 * [a-zA-Z-] - английские буквы от a до Z и знак "-" (если его добавляют в класс, то всегда в самый конец). https://regex101.com/r/BHiYSi/2
 ...
 *
 * Пример задачи: 'нужно из строки Меняем автора статьи 123 c "Иван" на "Пётр" и
 * извлечь идентификатор статьи и имена авторов.'
